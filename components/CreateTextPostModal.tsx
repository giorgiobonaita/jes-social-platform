...
export default function CreateTextPostModal({ visible, onClose, onPublished, authorUserId }: Props) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: '#fff', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Header */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px', paddingTop: 'calc(14px + var(--sat))', background: '#fff', borderBottom: '1px solid #F0F0F0', flexShrink: 0 }}>
