...
const postDir    = path.join(__dirname, 'app', 'post');
...
try {
  ...
  if (fs.existsSync(postDir))    { fs.renameSync(postDir, postTmp);       console.log('✓ app/post moved out'); }
  ...
  if (fs.existsSync(postTmp))    { fs.renameSync(postTmp, postDir);       console.log('✓ app/post restored'); }
}
