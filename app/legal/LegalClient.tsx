    ...
    <div className={s.page}>
      ...
      <div className={s.docWrap}>
        ...
        <div className={s.docSection}>
          ...
          <div className={s.infoBox}>
            <p>
              ...
              {it ? 'Sede legale:' : 'Registered office:'} Piazza della Concordia 18, 20831 Seregno (MB), Italia<br />
              P.IVA / C.F.: 02068500962<br />
              {it ? 'Email: ' : 'Email: '}
        ...
        <div className={s.docSection}>
          ...
          <ul>
            <li><strong>GB Studio S.r.l.</strong> — P.IVA 02068500962</li>
            <li>{it ? 'Sede legale: ' : 'Registered office: '}Piazza della Concordia 18, 20831 Seregno (MB), Italia</li>
            <li>{it ? 'Email: ' : 'Email: '}<a href="mailto:jes.socialdelleemozioni@gmail.com" className={s.linkOrange}>jes.socialdelleemozioni@gmail.com</a></li>
            <li>{it ? 'Sito web: ' : 'Website: '}<Link href="/" className={s.linkOrange}>jessocial.com</Link></li>
          </ul>
        </div>
