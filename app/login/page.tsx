    ...
    <div className="shell auth-page">
      ...
      <div className="auth-main">
        ...
        <div className="auth-buttons">
          ...
          <button className="btn-social neutral" onClick={() => router.push('/login/email')}>
            <span className="icon">
              <svg width="22" height="22" fill="none" stroke="#111" strokeWidth="1.8" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
            </span>
            Log in with email
          </button>
        </div>

        <button className="ghost-btn" onClick={() => router.push('/forgot-password')}>Forgot password?</button>

        <div className="auth-hint">
          <span className="auth-hint-text">Don&apos;t have an account?</span>
          <button className="ghost-btn" style={{ paddingLeft: 6 }} onClick={() => router.push('/auth')}>Sign up</button>
        </div>
      </div>
